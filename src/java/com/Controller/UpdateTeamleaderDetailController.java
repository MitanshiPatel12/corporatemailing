 ...
 * @author parth
 */
public class UpdateTeamleaderDetailController extends HttpServlet {
            ...
            throws ServletException, IOException 
   {
        ...
        try 
       {
              RegistrationEmployeeBean re=new RegistrationEmployeeBean();
                ...
                DoMethods.updateEmployeeDetails(re);
                
                
                        RequestDispatcher rd=request.getRequestDispatcher("ViewTeamleaderProfileJsp.jsp");
