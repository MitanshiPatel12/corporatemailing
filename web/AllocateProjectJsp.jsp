...
<head>
	<meta charset="utf-8" />
	<title>Corporate | Allocate Project</title>
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<!-- END PAGE HEADER-->
				<!-- BEGIN PAGE CONTENT-->
                                <form action="./AllocateProjectController" method="post">     
                                <div class="row-fluid">										
                                <div class="span12">
                                                        ...
                                                        <div class="controls">
                                                          ...
                                                          <select name="projectname">
                                                               <% while(rs.next())
                                                                    {
                                                               %>
                                                               <option value="<%=rs.getInt("ProjectId")%>" >  <%=rs.getString("ProjectName")%>  </option> 
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Team Leaders</div>
								<div class="tools">
										...
										<tr>
											...
											<th>First Name</th>
                                                                        ...
                                                                        <%
                                                                                    ...
                                                                                    while(rs.next())
                                                                                    {
                                                                                    int TeamLeaderId=rs.getInt("EmployeeId");
                        ...
                        <tr>
                            ...
                            <td><button type="submit" name="teamleader" value="<%=TeamLeaderId%>">Select</button></td>
