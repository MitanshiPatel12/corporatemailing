...
<head>
	<meta charset="utf-8" />
	<title>Corporate | Add Projects</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
                                                        Projects <small>Add Details</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								...
								<div class="tab-pane active " id="tab_2">
									<div class="portlet box green">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Fill Project Details</div>
											<div class="tools">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
											<form action="./AddProjectController" method="post" class="form-horizontal">
												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" name="projecttitle" class="m-wrap span12" placeholder="Enter Project Name">
															</div>
														</div>
													</div>
                                                                                                </div>
													...
													<div class="span6 ">
                                                                                                                <div class="control-group">
                                                                                                                    ...
                                                                                                                    <div class="controls">
                                                                                                                        <textarea class="span6 m-wrap" rows="2" name="projectsummary" placeholder="Project Summary"></textarea>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                        </div>
                                                                                                </div>
                                                                                                                ...
                                                                                                                <div class="control-group">
                                                                                                                        ...
                                                                                                                        <div class="controls">
                                                                                                                                 <div class="input-append" id="ui_date_picker_trigger">
                                                                                                                                      <i class="icon-calendar"></i>
                                                                                                                                            <input type="text" class="m-wrap medium" name="startingdate" /><span class="add-on"><i class="icon-calendar"></i></span>
                                                                                                                                 </div>
                                                                                                                        </div>
                                                                                                                </div>
                                                                                                        </div>
													...
													<div class="span6 ">
                                                                                                                <div class="control-group">
                                                                                                                        ...
                                                                                                                        <div class="controls">
                                                                                                                                 <div class="input-append" id="ui_date_picker_trigger">
                                                                                                                                      <i class="icon-calendar"></i>
                                                                                                                                            <input type="text" class="m-wrap medium" name="endingdate" /><span class="add-on"><i class="icon-calendar"></i></span>
                                                                                                                                 </div>
												...
												<!--/row--> 
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
                                                                                                                            <input type="text" id="clientname" class="m-wrap span12" placeholder="Client Name"  name="clientname">	
															</div>
														</div>
                                                                                                        </div>
                                                                                                </div>
														...
														<div class="control-group">
                                                                                                                    <label class="control-label">Contact No.</label>
                                                                                                                        <div class="controls">
                                                                                                                            <div class="input-icon left">
                                                                                                                                 <i class="icon-bell"></i>
                                                                                                                                 <input class="m-wrap " type="text" name="clientcontactno" placeholder="Client's Contact Number" /> 
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                </div>
													</div>
														...
														<div class="control-group">
                                                                                                                    <label class="control-label">Email Address Input</label>
                                                                                                                        <div class="controls">
                                                                                                                            <div class="input-icon left">
                                                                                                                                 <i class="icon-envelope"></i>
                                                                                                                                 <input class="m-wrap " type="text" name="clientemail" placeholder="Email Address" />    
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                </div>
													</div>
