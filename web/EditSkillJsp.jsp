	...
	<div class="page-container">
      ...
      <div class="control-group">
		<label class="control-label">Skill_ID</label>
			<div class="controls">
                            <input type="text" name="skillid" class="span6 m-wrap" value="<%=skillid%>" />
                                                        <span class="help-inline">Enter Your Skill_Id Here</span>
			</div>
	</div>
       <div class="control-group">
		<label class="control-label">Skill</label>
			<div class="controls">
                            <input type="text" name="addskill" class="span6 m-wrap" value="<%=skillname%>" />
