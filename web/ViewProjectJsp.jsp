								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									<thead>
                                                                            <tr>
                                                                                ...
                                                                                <th>City</th>
                                                                                <th>State</th>
                                                                                <th>Client's ContactNo.</th>
                                                                                <th>Client's Email_Id</th>
                                                                                <th> </th>
                                                                                <th> </th>
                                                                            </tr>
                                                                            </thead>
                                         ...
                                         <%
                                           ...
                                           // System.out.println("***********"+FirstName);
                                            String projecttitle=rs.getString("ProjectName");
                                            String summary=rs.getString("Summary");
                                            String startingdate=rs.getString("StartingDate");
                                            String endingdate=rs.getString("EndingDate");
                                            String language=rs.getString("Language");
                                            String clientname=rs.getString("ClientName");
                                            String street=rs.getString("ClientAddress");
                                            String city=rs.getString("ClientCity");
                                            String state=rs.getString("ClientState");
                                            String contactno=rs.getString("ClientContactNo");
                                            String email=rs.getString("ClientEmailId");
                                             ...
                                             %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="EditProjectJsp.jsp?projectid=<%=projectid%>&projecttitle=<%=projecttitle%>&summary=<%=summary%>&startingdate=<%=startingdate%>&endingdate=<%=endingdate%>&language=<%=language%>&clientname=<%=clientname%>&street=<%=street%>&city=<%=city%>&state=<%=state%>&contactno=<%=contactno%>&email=<%=email%>">Edit</a></td>
