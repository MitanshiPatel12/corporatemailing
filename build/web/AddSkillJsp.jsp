<%@page import="com.Bean.Master.Skill_Bean"%>
...
<head>
	<meta charset="utf-8" />
	<title>Corporate | Add Skill</title>
...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<form action="Add_Skill_Controller" method="post">
       ...
       <div class="control-group">
		<label class="control-label">Add Skill</label>
			<div class="controls">
				<input type="text" name="addskill" class="span6 m-wrap" />
                                                        <span class="help-inline">Enter Your Skill Here</span>
			</div>
	</div>
	...
	<div class="caption"><i class="icon-coffee"></i>Skill Table</div>
	<div class="tools">
	...
	<table class="table table-bordered table-hover">
               ...
               <%
        ArrayList<Skill_Bean> SkillData=(ArrayList<Skill_Bean>)request.getAttribute("SkillData");
             if(SkillData!=null)
             {
                 Iterator i= SkillData.iterator();
                 while(i.hasNext())
                 {
                     Skill_Bean pb=(Skill_Bean)i.next();
                     String skill_id=pb.getSkillId();
                     String skill_name=pb.getSkill();
                  ...
                  %>
                        ...
                        <tr>
                           <td><%= skill_id %></td>
                           <td><%= skill_name %></td>
                            <td><a href="EditSkillJsp.jsp?skillname=<%=skill_name%>&skillid=<%=skill_id%>">Edit</a></td>
                            <td><a href="DeleteSkillController?skillid=<%=skill_id%>">Delete</a></td>
                       </tr>
                   <% 
                   }
        }
