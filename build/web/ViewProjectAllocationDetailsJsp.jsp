...
<head>
	<meta charset="utf-8" />
	<title>Corporate | View Project</title>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									<thead>
                                         ...
                                         <%
                                            ...
                                            ps1=con.prepareStatement("SELECT employee_details.FirstName,projects.ProjectName,project_allocation_details.ProjectId,project_allocation_details.EmployeeId FROM project_allocation_details JOIN employee_details JOIN projects ON employee_details.EmployeeId=project_allocation_details.EmployeeId AND projects.ProjectId=project_allocation_details.ProjectId");       
                                            ...
                                            String project_id=rs1.getString("ProjectId");  
                                            String employee_id=rs1.getString("EmployeeId");
                                            String project_name=rs1.getString("ProjectName");
                                            String employee_name=rs1.getString("FirstName");
                                             ...
                                             %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="EditProjectJsp.jsp?projectid=<%=projectid%>&projecttitle=<%=project_id%>">Edit</a></td>
                                                                <td><a href="DeleteProjectController?projectid=<%=projectid%>">Delete</a></td>
                                                           </tr>
                                        <%
                                             }
                                        %>	
