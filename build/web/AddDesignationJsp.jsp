<%@page import="com.Bean.Master.Designation_Bean"%>
...
<head>
	<meta charset="utf-8" />
	<title>Corporate | Add Designation</title>
...
<!-- BEGIN BODY --><body class="page-header-fixed">
	...
	<div class="page-container">
      ...
      <form action="Add_Designation_Controller" method="post">
                                                                  
                                               
       
      
       <div class="control-group">
		<label class="control-label">Add Designation</label>
			<div class="controls">
				<input type="text" name="adddesignation" class="span6 m-wrap" />
                                                        <span class="help-inline">Enter Your Designation Here</span>
			</div>
	</div>
	...
	<div class="caption"><i class="icon-coffee"></i>Designation Table</div>
	<div class="tools">
	...
	<table class="table table-bordered table-hover">
           ...
           <%
                    ArrayList<Designation_Bean> DesignationData=(ArrayList<Designation_Bean>)request.getAttribute("DesignationData");
                    if(DesignationData!=null)
                        {
                             Iterator i= DesignationData.iterator();
                             while(i.hasNext())
                             {
                                 Designation_Bean pb=(Designation_Bean)i.next();
                                int designation_id=pb.getDesignationId();
                                 String designation_name=pb.getDesignation();
