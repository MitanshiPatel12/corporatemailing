...
<head>
	<meta charset="utf-8" />
	<title>Corporate | Edit Post</title>
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
                                                    ...
                                                    %>
      <form action="UpdateStateController" method="post">
                                                                  
                                               
       
      <div class="control-group">
		<label class="control-label">State_ID</label>
			<div class="controls">
                            <input type="text" name="stateid" class="span6 m-wrap" value="<%=stateid%>" />
                                                        <span class="help-inline">Enter Your State_id Here</span>
			</div>
	</div>
       <div class="control-group">
		<label class="control-label">State</label>
			<div class="controls">
                            <input type="text" name="addstate" class="span6 m-wrap" value="<%=statename%>" />
		...
		<button type="submit" name="add" class="btn green btn-primary" data-dismiss="modal">Update</button>
	</div>
