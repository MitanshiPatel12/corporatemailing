	...
	<div class="page-container">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li>
					<a href="TeamLeaderWelcomeJsp.jsp">
					<i class="icon-home"></i> 
					...
					<span class="selected"></span>
                                ...
                                <li class="start active">
                                    ...
                                    %>
                                        ...
                                        <a href="ViewTeamleaderProfileJsp.jsp?userid=<%=userid%>">
					...
					<a href="#">
					<i class="icon-pencil"></i> 
					<span class="title">View Developer</span>
					<span class="selected"></span>
					</a>
				</li>
                                 <li>
					...
					<a href="#">
					<i class="icon-pencil"></i> 
					<span class="title">Allocate Module</span>
					<span class="selected"></span>
					</a>
				</li>
								...
								<div class="tab-pane active " id="tab_2">
									<div class="portlet box green">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
                                                                                        <form action="UpdateTeamleaderDetailController" method="post" class="form-horizontal">
                                                                                            
                                                                                            <%
                                                                                                String uid=request.getParameter("userid");
                                                                                                //System.out.println("###########################333333333"+uid);
												...
												<h3 class="form-section">Person Info</h3>
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
                                                                                                                            <input type="text" name="userid" class="m-wrap span12" value="<%=uid%>">
															</div>
														</div>
													</div>
                                                                                                </div>
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
                                                                                                                            <input type="text" name="firstname" class="m-wrap span12" value="<%=fn%>">
															</div>
														</div>
													</div>
                                                                                                </div>
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
                                                                                                                            <input type="text" name="lastname" class="m-wrap span12" value="<%=ln%>">
															</div>
														</div>
													</div>
													<!--/span-->
                                                                                                                ...
                                                                                                                <div class="control-group">
                                                                                                                        ...
                                                                                                                        <div class="controls">
                                                                                                                                <div class="input-icon left">
                                                                                                                                       <i class="icon-calendar"></i>
                                                                                                                                       <input class="m-wrap" size="16" type="text" name="dateofbirth"  value="<%=dob%>" id="ui_date_picker_change_year_month" />
												...
												<div class="row-fluid">
														...
														<div class="control-group">
                                                                                                                    <label class="control-label">Email Address Input</label>
                                                                                                                        <div class="controls">
                                                                                                                            <div class="input-icon left">
                                                                                                                                 <i class="icon-envelope"></i>
                                                                                                                                 <input class="m-wrap " type="text" name="email" value="<%=eml%>" />    
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                </div>
													</div>
														...
														<div class="control-group">
                                                                                                                    <label class="control-label">Contact No.</label>
                                                                                                                        <div class="controls">
                                                                                                                            <div class="input-icon left">
                                                                                                                                 <i class="icon-bell"></i>
                                                                                                                                 <input class="m-wrap " type="text" name="contactno" value="<%=con%>" />    
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                </div>
													</div>
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
                                                                                                                            <input type="text" id="UserName" class="m-wrap span12" value="<%=username%>" name="username">
													...
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
                                                                                                                            <input type="text" id="Password" class="m-wrap span12" value="<%=password%>" value="password"  name="password">
													...
													<div class="span12 ">
														<div class="control-group">
															<label class="control-label">Street</label>
                                                                                                                        ...
                                                                                                                        <div class="input-icon left">
                                                                                                                                 <i class="icon-home"></i>
                                                                                                                                 <input type="text" name="street" class="m-wrap span12" value="<%=add%>">
                                                                                                                        </div>
                                                                                                                        </div>
														</div>
													</div>
