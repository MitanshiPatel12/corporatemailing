...
<head>
	<meta charset="utf-8" />
	<title>Corporate | User Login</title>
...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="./AdminLoginCheckServlet" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="userid"/>
					</div>
				</div>
			</div>
			<div class="control-group">
		...
		<form class="form-vertical register-form" action="./SignUp_Registration_Controller" method="post">
			<h3 >Sign Up</h3>
