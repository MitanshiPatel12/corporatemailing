...
<%@page import="com.Bean.Master.City_Bean"%>
...
<head>
	<meta charset="utf-8" />
	<title>Corporate | Add City </title>
...
<body class="page-header-fixed">
				...
				<div id="dashboard">
					...
					<div class="row-fluid">
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
                                <form action="./Add_City_Controller" method="post">
   ...
   <%
     ...
     %>
       ...
       <div class="control-group">
		<label class="control-label">Add City </label>
			<div class="controls">
				<input type="text" name="addcity" class="span6 m-wrap" />
                                                        <span class="help-inline">Enter Your City Here</span>
			</div>
	</div>
	...
	<div class="caption"><i class="icon-coffee"></i>City Table</div>
	<div class="tools">
