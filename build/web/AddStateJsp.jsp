<%@page import="com.Bean.Master.State_Bean"%>
...
<head>
	<meta charset="utf-8" />
	<title>Corporate | Add State</title>
...
<body class="page-header-fixed">
	...
	<div class="page-container">
		...
		<form action="Add_State_Controller" method="post">
                                                                  
                                               
       
      
       <div class="control-group">
		<label class="control-label">Add State </label>
			<div class="controls">
				<input type="text" name="addstate" class="span6 m-wrap" />
                                                        <span class="help-inline">Enter Your State Here</span>
			</div>
	</div>
	...
	<div class="caption"><i class="icon-coffee"></i>State Table</div>
	<div class="tools">
	...
	<table class="table table-bordered table-hover">
        ...
        ArrayList<State_Bean> StateData=(ArrayList<State_Bean>)request.getAttribute("StateData");
             if(StateData!=null)
             {
                 Iterator i= StateData.iterator();
                 while(i.hasNext())
                 {
                     State_Bean pb=(State_Bean)i.next();
                     String state_id=pb.getStateId();
                     String state_name=pb.getState();
                  ...
                  %>
                        ...
                        <tr>
                           <td><%= state_id %></td>
                           <td><%= state_name %></td>
                           <td><a href="EditStateJsp.jsp?statename=<%=state_name%>&stateid=<%=state_id%>">Edit</a></td>
                           <td><a href="DeleteStateController?stateid=<%=state_id%>">Delete</a></td>
                       </tr>
                   <% 
                   }
        }
